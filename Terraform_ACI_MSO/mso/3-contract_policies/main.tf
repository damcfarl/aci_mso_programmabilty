...
resource "mso_schema_template_filter_entry" "https_obj" {
  schema_id          = data.mso_schema.schema_obj.id
  template_name      = data.mso_schema.schema_obj.template_name
  name               = mso_schema_template_filter_entry.https_obj.name
  display_name       = mso_schema_template_filter_entry.https_obj.display_name
  entry_name         = "HTTPs"
...
resource "mso_schema_template_filter_entry" "ssh_obj" {
  schema_id          = data.mso_schema.schema_obj.id
  template_name      = data.mso_schema.schema_obj.template_name
#  name               = mso_schema_template_filter_entry.ssh.name
#  display_name       = mso_schema_template_filter_entry.ssh.display_name
  name               = var.filter_ssh
